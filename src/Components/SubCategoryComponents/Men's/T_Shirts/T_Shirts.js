...
import SubCategoryMenTShirtData from '../../../AllProductData/SubCategoryMenTShirtData/SubCategoryMenTShirtData'
import SubCategoryMenTShirtCard from '../../../ReuseAbleComponent/Card/SubCategoryMenTShirtCard'
...
export default function T_Shirts() {
       ...
       const data = SubCategoryMenTShirtData.map(item=>{
         return (
            <SubCategoryMenTShirtCard 
